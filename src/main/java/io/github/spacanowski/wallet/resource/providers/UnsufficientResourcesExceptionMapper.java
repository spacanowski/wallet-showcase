...
@Provider
public class UnsufficientResourcesExceptionMapper implements ExceptionMapper<InsufficientResourcesException> {

    @Override
    public Response toResponse(InsufficientResourcesException exception) {
